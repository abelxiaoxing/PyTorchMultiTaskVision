...
class TimesBlock(nn.Module):
    def __init__(self, seq_len, pred_len, d_model, top_k, d_ff, num_kernels):
...
class Model(nn.Module):
    def __init__(
        ...
        self.model = nn.ModuleList(
            [
                TimesBlock(seq_len, pred_len, d_model, top_k, d_ff, num_kernels)
    ...
    def forward(self, x_enc):
        ...
        result = dec_out[:, -self.pred_len :, :].squeeze(-1)  # [B, L, D]
        return result
